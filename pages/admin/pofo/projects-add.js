...
import { addPortfolio } from "../../../api/profile";
import { router, useEffect, useState } from "../../../lib";

const AddProjectPorfo = () => {
  ...
  useEffect(() => {
    ...
    const exampleInputDes = document.getElementById("exampleInputDes");
    ...
    form.addEventListener("submit", (e) => {
      ...
      const formData = {
        ...
        img: "https://images.pexels.com/photos/546819/pexels-photo-546819.jpeg?auto=compress&cs=tinysrgb&w=600.jpg",
        name: exampleInputName.value,
        describe: exampleInputDes.value,
  ...
  return `
  <!-- Favicon -->
  <link href="/../../assetsadmin/img/avatarcon.ico" rel="icon">
      ...
      <nav class="navbar bg-light navbar-light">
          ...
          <div class="navbar-nav w-100">
              ...
              <div class="nav-item dropdown">
                  <a href="/projectporfos" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Portfolio</a>
              ...
              <div class="bg-light rounded h-100 p-4">
                  ...
                  <form id="form-add">
                      ...
                      <div class="mb-3">
                          ...
                          <input type="file" class="form-control" id="exampleInputImage" required>
                      </div>
                      <div class="mb-3">
                          <label for="exampleInputDes" class="form-label">Describe</label>
                          <input type="text" class="form-control" id="exampleInputDes" required>
                      </div>
...
export default AddProjectPorfo;
