        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="#" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-danger"><i class="fa fa-time me-2"></i>ADMIN</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="./addpofor" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Menu</a>
                        <div class="dropdown-menu bg-transparent border-0">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-12">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">List Posts</h6><a href="/addpost"><button class="btn btn-info m-2"> Add Posts</button></a>
                            ...
                            ${data
                              .map((project, index) => {
                                ...
                                <tr>
                                    ...
                                    <td><img style="width: 100px;" src="/../../assetsadmin/img/avatar2.jpg" alt=""></td>
                                    <td>${project.name}</td>
                                    <td>${project.age}</td>
                                    ...
                                    <td><button class="btn btn-danger btn-remove m-2" data-id="${
                                      project.id
                                    }">Delete</button> <a href="/updatepost/${
                                  project.id
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            ...
                            Designed By <a href="https://htmlcodex.com">VA 501.F</a>
                        </br>
