...
const EditProjectPost = ({id}) => {
  ...
  useEffect(() => {
    ...
    const exampleInputAge = document.getElementById("exampleInputAge");
    const exampleInputPosition = document.getElementById("exampleInputPosition");
    ...
    form.addEventListener("submit", (e) => {
      ...
      const formData = {    
        ...
        image: "https://images.pexels.com/photos/546819/pexels-photo-546819.jpeg?auto=compress&cs=tinysrgb&w=600.jpg",
        name: exampleInputName.value,
        age: exampleInputAge.value,
        position: exampleInputPosition.value,
      };
      updatePost(formData)
      .then(() => {
              ...
              <div class="bg-light rounded h-100 p-4">
                  ...
                  <form id="form-add">
                      ...
                      <div class="mb-3">
                          ...
                          <input type="text" class="form-control" value="${data.name}" id="exampleInputName">
                      </div>
                      <div class="mb-3">
                          <label for=" exampleInputAge" class="form-label">Age</label>
                          <input type="number" class="form-control" value="${data.age}" id="exampleInputAge">
                      </div>
                      <div class="mb-3">
                          <label for="exampleInputPosition" class="form-label">Position</label>
                          <input type="text" class="form-control" value="${data.position}" id="exampleInputPosition">
                      </div>
