      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="mt-5">
            ...
            <h1 class="intro-title marker" data-aos="fade-left" data-aos-delay="50">I’m ${name}</h1>
            <p class="lead fw-normal mt-3" data-aos="fade-up" data-aos-delay="100"> ${position}</p>
            `).join("")}
